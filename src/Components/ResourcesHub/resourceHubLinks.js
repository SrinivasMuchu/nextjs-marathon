...
export const RESOURCE_HUB_SECTIONS = [
  {
    ...
    links: [
      {
        href: '/resources/hire-a-cad-designer-online-what-to-look-for-and-how-to-get-started',
      ...
      {
        href: '/resources/online-cad-design-services-how-they-work-and-when-to-use-one',
      ...
      {
        href: '/resources/cad-design-outsourcing-a-complete-guide-for-product-teams',
      ...
      {
        href: '/resources/freelance-cad-designer-vs-cad-service-platform-which-is-right-for-your-project',
  ...
  },
  {
    ...
    links: [
      {
        href: '/resources/hire-a-solidworks-designer-online-production-ready-files-in-24-hours',
      ...
      {
        href: '/resources/fusion-360-design-service-get-a-custom-3d-model-from-a-vetted-designer',
      ...
      {
        href: '/resources/autocad-drafting-services-online-2d-drawings-conversions-and-technical-docs',
      ...
      {
        href: '/resources/revit-modeling-services-for-architects-and-engineers',
  ...
  },
  {
    ...
    links: [
      {
        href: '/resources/3d-product-modeling-service-from-concept-to-production-ready-cad-file',
      ...
      {
        href: '/resources/2d-cad-drawing-service-technical-drawings-for-manufacturing-and-patents',
      ...
      {
        href: '/resources/sheet-metal-cad-design-service-custom-parts-for-fabrication',
      ...
      {
        href: '/resources/stl-file-design-service-3d-print-ready-models-on-demand',
  ...
  },
  {
    ...
    links: [
      {
        href: '/resources/mechanical-engineering-cad-design-service-get-expert-cad-work-done-fast',
      ...
      {
        href: '/resources/product-development-cad-services-for-inventors-and-startups',
      ...
      {
        href: '/resources/architectural-cad-drafting-services-floor-plans-elevations-and-as-builts',
      ...
      {
        href: '/resources/product-rendering-service-photorealistic-3d-renders-from-your-cad-files',
  ...
  },
  {
    ...
    links: [
      {
        href: '/resources/how-much-does-cad-design-cost-pricing-guide-for-3d-modeling-and-drafting',
      ...
      {
        href: '/resources/best-cad-design-services-online-in-2025-a-comparison-guide',
      ...
      {
        href: '/resources/how-to-write-a-cad-design-brief-templates-and-tips-for-getting-accurate-quotes',
      ...
      {
        href: '/resources/pdf-to-cad-conversion-service-get-editable-dwg-step-files-from-any-drawing',
...
function getSlugFromResourceHref(href) {
  return href?.split('/').filter(Boolean).at(-1) ?? ''
}

/**
 * @param {string} slug
 * @returns {{ id: string, heading: string } | null}
 */
export function getResourceHubCategoryBySlug(slug) {
  if (!slug) return null

  const section = RESOURCE_HUB_SECTIONS.find((item) =>
    item.links.some((link) => getSlugFromResourceHref(link.href) === slug)
  )
