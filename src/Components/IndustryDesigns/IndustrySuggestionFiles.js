  ...
  return (
    <div className={styles['industry-design-suggestion-designs']}>
      {visibleItems.map((item, index) => (
        <Link key={index} className={libraryStyles['library-designs-items-container']}
          ...
          <div style={{
            ...
            {/* <Image className={libraryStyles['industry-design-suggestion-designs-cont-img']} alt={item.page_title} src={`${DESIGN_GLB_PREFIX_URL}${item._id}/sprite_0_150.webp`} width={350} height={220}
              style={{ borderBottom: '1px solid grey' }} />You can add an icon/image here */}
             <HoverImageSequence design={item} width={300} height={250}/>
