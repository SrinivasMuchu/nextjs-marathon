...
import {
  ...
  DesignPostDownloadBannerHost,
  DesignConversionStickyBarHost,
} from './DesignConversionContext';
...
function IndustryDesign({ design, designData, type }) {
        ...
        links={
          !type
            ? [
                ...
                {
                  label: `${designData.response.part_name}`,
                  href: `/industry/${design.industry}/${design.part}`,
                },
                {
                  label: `${designData.response.page_title}`,
                  href: `/industry/${design.industry}/${design.part}/${design.design_id}`,
                },
              ]
            : [
      ...
      <div className={styles['industry-design-header-container']}>
        ...
        <div className={styles['industry-design-header-container-right']}>
          ...
          <CadDesignDownload
            ...
            designTitle={designData.response.page_title}
          />
          {isLibraryDetail && (
          ...
          <div className={styles['industry-design-files-container']}>
            <div className={styles['industry-design-files-head']}>
              ...
              <p>
                The files are shared to help you get inspired and speed up your workflow. They may
                not be fully accurate or production-ready, so review carefully before use.
              </p>
            </div>
          </div>
          {response && (
            <IndustryDesignFilesList designData={response} isLibraryDetail={isLibraryDetail} />
          )}
          {designData.response && (
            <div
              className={`${styles['industry-design-files-container']} ${styles['industry-design-files-supporting-wrapper']}`}
            >
  ...
  return (
    <>
      ...
      {isLibraryDetail && response ? (
        <DesignConversionProvider designData={response}>
          <div className={styles['industry-design-page-root']}>{pageBody}</div>
