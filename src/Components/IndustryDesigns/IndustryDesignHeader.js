  ...
  return (
    <div className={styles['industry-design-header']}>
        ...
        <div className={styles['industry-design-header-viewer']}>
            ...
            <Link href={`/tools/cad-renderer?fileId=${designData._id}&format=${designData.file_type?designData.file_type:'step'}`} rel="nofollow"><button >Open in 3D viewer</button></Link>   
