        ...
        <>
            ...
            <CadFileConversionWrapper convert={convert}>
                    <div className={styles["cad-dropzone-content"]}>
                        ...
                        {convert ? `Supported formats:${allowedFormats.join(", ")}` : "Supported formats: STEP (.step, .stp), IGES (.igs, .iges), STL (.stl), PLY (.ply), OFF (.off), BREP (.brp, .brep), OBJ (.obj), DXF (.dxf), DWG (.dwg)"}
