      ...
      <div className={styles.transparencyLayout}>
        <div className={styles.transparencyMain}>
          ...
          <p className={styles.transparencyIntro}>
            ...
            <span className={styles.transparencyHighlight}>Claude (Anthropic)</span> analyses the
        ...
        <aside className={styles.transparencyPanel} aria-label="AI model and run stats">
          <div className={styles.transparencyPanelHead}>
            <code className={styles.transparencyModel}>claude-opus-4-6</code>
            <span className={styles.transparencyStatus}>Active</span>
          </div>
          <p className={styles.transparencyPanelDesc}>
            Claude Opus reasons over multi-view renders of your 3D geometry to select views,
